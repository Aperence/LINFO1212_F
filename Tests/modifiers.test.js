...
describe('Execute tests on modifs pages', () => {
  ...
  test("Vérifie que l'on ne peut se soumettre sans avoir choisi de nom si on est un Admin (employé)", async () => {
  ...
  test("Vérifie que l'on ne peut se soumettre sans avoir choisi de nom si on est un Admin (animal)", async () => {
  ...
  test("Vérifie que l'on ne peut se soumettre sans avoir rempli le nom (employé)", async () => {
  ...
  test("Vérifie que l'on ne peut se soumettre sans avoir rempli la tâche (employé)", async () => {
    await driver.get( url + "/staffmodif?name=Georges");
    await driver.wait( async ()=>{
      try{
  ...
  test("Vérifie que l'on ne peut se soumettre sans avoir rempli le nom (animal)", async () => {
  ...
  test("Vérifie que l'on ne peut se soumettre sans avoir rempli la tâche (animal)", async () => {
    await driver.get( url + "/animalmodif?name=test");
    await driver.wait( async ()=>{
      try{
